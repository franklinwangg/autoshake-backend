# Sprint 2 Plan
**Product:** AutoShake AI MVP  | **Due:** May 3, 2026
...
## User Stories
### US1 - As a user, I want to select multiple jobs so that I can generate tailored resumes for each one. (8)
**Acceptance Criteria:**
...
| 1.3 - Parser is fired for each job you click | Tyler | 4h |
| 1.4 - Jobs are only added when extension is enabled | Tyler | 2h |
| **Story Total** | | **9h** |

### US2 - As a user, I want the resume outputs to follow a predictable format. (5)
**Acceptance Criteria:**
...
### US3 - As a user, I want to submit my selected jobs so that they are sent for processing. (3)
**Acceptance Criteria:**
...
| 3.3 - User limits to not use all of our API tokens | Franklin | 4h |
| **Story Total** | | **7h** |

### (Partial) US5 - As a user, I want the jobs I've sent in to be processed and returned to me as PDFs. (13)
**Acceptance Criteria:**
...
| Task | Assignee | Hours |
|------|----------|-------|
| 5.1 - Backend server has an API | Nirav/Franklin | 8h |
| 5.3 - Data Sent to ML pipeline | Nirav/Franklin | 4h |
| 5.4 - PDFs generated from ML output | Nataniel | 8h |
| **Story Total** | | **20h** |
